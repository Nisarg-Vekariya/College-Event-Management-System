...
@section('title', '818 Uni Event - University Event')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
            <h2 class="section-title text-3xl sm:text-4xl lg:text-5xl font-heading font-bold text-text-dark mb-6">
                About <span class="text-primary">818 Uni Event</span>
            </h2>
        ...
        <div class="about-content grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div class="content-text">
                ...
                <p class="content-paragraph text-text-light font-body text-lg leading-relaxed mb-6">
                    Since 2007, 818 Uni Event has celebrated talent and teamwork, bringing together over 10,000 students from 81 countries. This magnificent event showcases the dedication and creativity cultivated throughout the year.
                </p>
                <p class="content-paragraph text-text-light font-body text-lg leading-relaxed mb-8">
                    818 Uni Event is a vibrant blend of excellence, diversity, and camaraderie. Beyond celebrating achievements, it fosters inclusivity, sportsmanship, and a sense of unity, making it one of the most eagerly awaited events of the year.
                </p>
            ...
            <div class="content-visual">
                <div class="visual-card bg-gradient-to-br from-primary/10 to-primary/30 rounded-2xl p-8 h-full flex items-center justify-center min-h-[400px]">
                    <div class="text-center">
                        ...
                        <p class="visual-subtitle text-text-light font-body text-lg">Experience the magic of 818 Uni Event</p>
                    </div>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
            ...
            <p class="gallery-subtitle text-xl text-text-light font-body max-w-3xl mx-auto leading-relaxed">
                Relive the unforgettable moments from previous 818 Uni Event editions
            </p>
        </div>
...
<section class="cta-section py-16 lg:py-24 bg-gradient-to-r from-primary to-red-700 text-white relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <h2 class="cta-title text-3xl sm:text-4xl lg:text-5xl font-heading font-bold mb-6">
            Ready to Join <span class="text-yellow-300">818 Uni Event</span>?
        </h2>
