...
<head>
    ...
    <title>Register | 818 Uni Event</title>
    ...
    <div class="register-container bg-white shadow-2xl rounded-2xl w-full max-w-lg mx-4 overflow-hidden relative z-10">
        ...
        <div class="register-header  px-8 py-8 text-center border-b border-gray-100">
            ...
            <h1 class="brand-title text-2xl font-heading font-bold text-text-dark mb-2">
                Join <span class="text-primary">818 Uni Event</span>
            </h1>
                    ...
                    <div class="info-grid grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="form-group sm:col-span-2">
                            ...
                            <input type="text" id="name" name="name" readonly
                                class="form-input w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50 font-body text-text-dark">
                        </div>
        ...
        axios.post(this.action, formData)
            .then(response => {
                ...
                if (response.data.success) {
                    ...
                    // Show success with SweetAlert2 instead of modal
                    Swal.fire({
                        title: 'Account Created Successfully!',
                        text: 'Your account has been created successfully. Please check your email for login credentials.',
                        icon: 'success',
