...
<head>
    ...
    <title>Your 818 Uni Event Account Details</title>
...
<body>
    <div class="email-container">
        ...
        <div class="email-header">
            <div class="logo">818 Uni Event</div>
        ...
        <div class="email-content">
            ...
            <div class="welcome-message">
                We're excited to welcome you to <strong>818 Uni Event</strong>! Your account has been successfully created and you're all set to begin your journey with us.
            </div>
            ...
            <div class="welcome-message">
                If you have any questions or need assistance, please don't hesitate to reach out to our support team. We're here to help make your experience with 818 Uni Event exceptional.
            </div>
        </div>
        ...
        <div class="email-footer">
            <div class="footer-text">
                This email was sent to {{ $studentEmail }} because an account was created for 818 Uni Event.
            </div>
            ...
            <div class="footer-text" style="margin-top: 20px;">
                © 2025 Team 818. All rights reserved.
            </div>
        </div>
    </div>
</body>
