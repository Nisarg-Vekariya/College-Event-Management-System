        ...
        <table class="min-w-full text-left text-sm font-body">
            <thead class="bg-gray-100 text-text-dark uppercase text-left">
                <tr class="font-heading">
                    <th class="px-4 py-3 border text-text-dark">Name</th>
                    <th class="px-4 py-3 border text-text-dark">Email</th>
                    <th class="px-4 py-3 border text-text-dark">Enrolment No</th>
                    <th class="px-4 py-3 border text-text-dark">Role</th>
                    <th class="px-4 py-3 border text-text-dark">Joined</th>
