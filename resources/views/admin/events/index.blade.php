...
<div class="p-6 font-body">
    ...
    <!-- Delete All Students -->
    <form action="{{ route('admin.events.deleteAll') }}" method="POST"
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50 transition">
                    ...
                    <td class="px-4 py-2 flex gap-2">
                        ...
                        <form action="{{ route('admin.events.destroy', $event->event_id) }}" method="POST" onsubmit="return confirm('Are you sure?')">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
